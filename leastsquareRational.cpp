...
// Aproximação de curvas pelo método dos mínimos quadrados racional
#include<iostream>
#include<iomanip>
#include<cmath>
using namespace std;
int main()
{
    ...
    for (i=0;i<n;i++)
        y_fit[i]=1/(a*x[i]+b);                    //to calculate y(fitted) at given x points
    ...
    cout<<"\nThe linear fit rational is of the form:\n\n"<<"1/ \n"<<a<<"x + "<<b<<endl;        //print the best fit line
    return 0;
}   