...
// CIC250 – Cálculo Numerico para Computacao
// Exercicio Pratico 04 – 30/04/2020
// 2017019950 – Ernani Batista Serafim
// Resolucao de sistemas lineares pelo Metodo de Gauss com Pivoteamento 
#include<iostream>
#include<iomanip>
using namespace std;
int main()
{
    ...
    cout.setf(ios::fixed);
    cout<<"\n entrar com numero de equacoes\n";
    cin>>n;
    float a[n][n+1],x[n];        //Matriz de elementos
